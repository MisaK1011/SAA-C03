...
```md
aws s3 mb s3://checksums-examples-ab-2342-mk-1234
```
...
```
aws s3 cp myfile.txt s3://checksums-examples-ab-2342-mk-1234
aws s3api head-object --bucket checksums-examples-ab-2342-mk-1234 --key myfile.txt
```
...
--bucket="checksums-examples-ab-2342-mk-1234" \
--key="myfilesha1.txt" \
--body="myfile.txt" \
